...
describe('form controls', () => {
  ...
  it('uses a custom listbox and returns only values declared by Select options', () => {
    ...
    fireEvent.click(screen.getByRole('combobox', { name: '工作区' }));
    fireEvent.click(screen.getByRole('option', { name: '团队工作区' }));
